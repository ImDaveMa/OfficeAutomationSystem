 ...
 * 月视图
 */
public class OAMonthView extends MonthView {
...
//    private float mSchemeBaseLine;
    ...
    public OAMonthView(Context context) {
        super(context);
...
//        canvas.drawCircle(x + mItemWidth - mPadding - mRadiu / 2, y + mPadding + mRadiu, mRadiu, mSchemeBasicPaint);
        canvas.drawCircle(x + mItemWidth / 2, y + mItemHeight - mPadding*2 , mRadiu, mSchemeBasicPaint);

//        canvas.drawText(calendar.getScheme(), x + mItemWidth - mPadding - mRadiu, y + mPadding + mSchemeBaseLine, mTextPaint);
