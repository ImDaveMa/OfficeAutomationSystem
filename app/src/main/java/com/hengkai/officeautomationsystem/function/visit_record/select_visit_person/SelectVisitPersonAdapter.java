 ...
 */
public class SelectVisitPersonAdapter extends RecyclerView.Adapter<SelectVisitPersonAdapter.ViewHolder> {

    private List<VisitRecordDetailGetVisitUnitEntity.DATABean> mList;

    public SelectVisitPersonAdapter(List<VisitRecordDetailGetVisitUnitEntity.DATABean> list) {
        this.mList = list;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    mListener.onClick(bean.id, bean.name, bean.department);
                }
            }
        });
    }
    ...
    public interface OnItemClickListener {
        void onClick(int ID, String name, String department);
    }
