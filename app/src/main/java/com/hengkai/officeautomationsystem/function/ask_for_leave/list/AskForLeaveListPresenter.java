 ...
 */
public class AskForLeaveListPresenter extends BasePresenter<AskForLeaveListActivity> {

    private final AskForLeaveListModel model;

    public AskForLeaveListPresenter() {
