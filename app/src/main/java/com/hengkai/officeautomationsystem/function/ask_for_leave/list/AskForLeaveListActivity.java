 ...
 * 请假记录列表页面
 */
public class AskForLeaveListActivity extends BaseActivity<AskForLeaveListPresenter> {
    ...
    @Override
    protected AskForLeaveListPresenter bindPresenter() {
        return new AskForLeaveListPresenter();
    }
    ...
    private void setupRecyclerView() {
        ...
        adapter = new AskForLeaveListAdapter(mList);
