 ...
 * 底部弹窗的适配器
 */
public class GoodsBottomDialogAdapter extends RecyclerView.Adapter<GoodsBottomDialogAdapter.ViewHolder> {

    private List<GoodsParamsEntity.ProjectBean> mList;

    public GoodsBottomDialogAdapter(List<GoodsParamsEntity.ProjectBean> list) {
        mList = list;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final GoodsParamsEntity.ProjectBean bean = mList.get(position);
    ...
    public interface OnItemClickListener {
        void onClick(GoodsParamsEntity.ProjectBean bean);
    }
